...
VALUES 	('BUILDING_LALIBELA', 'SPECIALIST_CITIZEN', 'YIELD_FAITH', 1),
		...
		('BUILDING_HARMANDIR', 'SPECIALIST_MERCHANT', 'YIELD_CULTURE', 2);
...
VALUES	('BUILDING_ITSUKUSHIMA', 	'RESOURCE_WHALE', 	'YIELD_FAITH', 	3),
		...
		('BUILDING_GOBEKLI', 		'RESOURCE_MARBLE', 	'YIELD_FAITH', 	4),
		('BUILDING_GOBEKLI', 		'RESOURCE_STONE', 	'YIELD_FAITH', 	4);
...
INSERT INTO Building_YieldChangesPerReligion
		(BuildingType, YieldType, Yield)
VALUES 	('BUILDING_MAHADEVA', 'YIELD_PRODUCTION', 600);

...
) WHERE CivilizationType = 'CIVILIZATION_SENSHI_ZANZIBAR';
--==========================================================================================================================
-- MASTER TABLES
--==========================================================================================================================
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('CIVILIZATION_THP_SEN_TUVA',	'GreatestEarth',	80,		59),
		('CIVILIZATION_THP_SEN_TUVA',	'Yagem',			70,		74),
		('CIVILIZATION_THP_SEN_TUVA',	'Yahem',			97,		63),
		('CIVILIZATION_THP_SEN_TUVA',	'EarthMk3',			66,		64),
		('CIVILIZATION_THP_SEN_TUVA',	'AfriAsiaAust',		91,		74),
		('CIVILIZATION_THP_SEN_TUVA',	'Asia',				33,		60),
		('CIVILIZATION_THP_SEN_TUVA',	'AsiaSmall',		22,		46),
		('CIVILIZATION_THP_SEN_TUVA',	'AsiaSteppeGiant',	110,	58),
		('CIVILIZATION_THP_SEN_TUVA',	'SeaOfJapan',		110,	58);

DELETE FROM MinorCivilizations_YnAEMP WHERE MinorCivType = 'MINOR_CIV_KYZYL';
--------------------------------------------------------------------------------------------------------------------------
-- Civilizations_YagemRequestedResource
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType, 					MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT	'CIVILIZATION_THP_SEN_TUVA',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_DECOLONIZATION',		 5),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_MERCENARY',				 3),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 3),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 6), --Scale of Liberal to Authoritarian.
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_LEGAL',			 7), 	
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_CULTURE',		 3),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_ECONOMIC',		 1),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 1),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_FOREIGN',		 8),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_INDUSTRY',		 1),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_MILITARY',		 5),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_REFORM_RELIGION',		 8),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_SLAVERY',				 0),
		('LEADER_THP_SEN_DONDUK',	'FLAVOR_JFD_STATE_RELIGION',		 8);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_THP_SEN_TUVA',	ArtDefineTag, CultureType,	SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag

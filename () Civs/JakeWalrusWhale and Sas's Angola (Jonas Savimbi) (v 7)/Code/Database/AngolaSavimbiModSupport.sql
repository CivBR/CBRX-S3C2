...
VALUES	('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_DECOLONIZATION',		5),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_MERCENARY',				8),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	1),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_GOVERNMENT',		8),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_LAW',			3),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_DIPLOMACY',		6),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_ECONOMY',		3),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_EDUCATION',		1),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_INDUSTRY',		8),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_MILITARY',		7),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_RELIGION',		0),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_SOCIETY',		6),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_REFORM_WELFARE',		2),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_SLAVERY',				6),
		('LEADER_JWW_JONAS_SAVIMBI',	'FLAVOR_JFD_STATE_RELIGION',		2);
--==========================================================================================================================
-- CIVILIZATIONS
--==========================================================================================================================
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('CIVILIZATION_JWW_ANGOLA',	'Yagem',				26,		20),
		('CIVILIZATION_JWW_ANGOLA',	'Yahem',				66,		24),
		('CIVILIZATION_JWW_ANGOLA',	'Cordiform',			37,		7),
		('CIVILIZATION_JWW_ANGOLA',	'GreatestEarth',		54,		12),
		('CIVILIZATION_JWW_ANGOLA',	'EarthMk3',				28,		17),
		('CIVILIZATION_JWW_ANGOLA',	'AfriAsiaAust',			30,		24),
		('CIVILIZATION_JWW_ANGOLA',	'AfricaLarge',			31,		23),
		('CIVILIZATION_JWW_ANGOLA',	'AfriGiant',			67,		45),
		('CIVILIZATION_JWW_ANGOLA',	'AfriSouthEuro',		37,		20),
		('CIVILIZATION_JWW_ANGOLA',	'SouthernAfrica',		45,		74),
		('CIVILIZATION_JWW_ANGOLA',	'Pacific',				32,		47);
--------------------------------------------------------------------------------------------------------------------------	
-- Civilizations_YnAEMPRequestedResources
--------------------------------------------------------------------------------------------------------------------------	
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType,				MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4, Req5, Yield5, Req6, Yield6)
SELECT	'CIVILIZATION_JWW_ANGOLA',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4, Req5, Yield5, Req6, Yield6
...
VALUES	('CIVILIZATION_JWW_ANGOLA', 	'GOVERNMENT_JFD_REPUBLIC',	100);
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('CIVILIZATION_JWW_ANGOLA',	'CULTURE_JFD_BANTU',	'_JFD_BANTU',	'JFD_Bantu',	'JFD_Bantu',		'JFD_Bantu');
--==========================================================================================================================
...
VALUES	('LEADER_JWW_JONAS_SAVIMBI',		'RESPONSE_INFLUENTIAL_ON_AI',	'TXT_KEY_LEADER_JWW_JONAS_SAVIMBI_INFLUENTIAL_ON_AI%',		1),
		('LEADER_JWW_JONAS_SAVIMBI',		'RESPONSE_INFLUENTIAL_ON_HUMAN','TXT_KEY_LEADER_JWW_JONAS_SAVIMBI_INFLUENTIAL_ON_HUMAN%',		1);
--=========================================================================================================================
...
SELECT  'LEADER_JWW_JONAS_SAVIMBI',	'POLICY_CHARISMATIC_X',	'POLICY_INDUSTRIOUS_X'
WHERE EXISTS (SELECT * FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X');
------------------------------	
-- Leaders
------------------------------	
UPDATE Leaders 
SET Description = 'Jonas Savimbi [ICON_HAPPINESS_1][ICON_PRODUCTION]'
WHERE Type = 'LEADER_JWW_JONAS_SAVIMBI'
...
WHERE Type = 'CIVILIZATION_JWW_ANGOLA'
...
SELECT	'CIVILIZATION_JWW_ANGOLA',	CultureType,			CultureEra

...
WHERE Type = 'CIVILIZATION_DMS_BOTSWANA'
...
VALUES	('CIVILIZATION_DMS_BOTSWANA',	'Cordiform',		40, 4),
		('CIVILIZATION_DMS_BOTSWANA',	'GreatestEarth',	57, 7),
		('CIVILIZATION_DMS_BOTSWANA',	'Yagem',			30, 13),
		('CIVILIZATION_DMS_BOTSWANA',	'Yahem',			69, 16),
		('CIVILIZATION_DMS_BOTSWANA',	'AfricaLarge',		40, 12),
		('CIVILIZATION_DMS_BOTSWANA',	'AfriAsiaAust',		37, 14),
		('CIVILIZATION_DMS_BOTSWANA',	'AfriGiant',		85, 34),
		('CIVILIZATION_DMS_BOTSWANA',	'AfriSouthEuro',	45, 9),
		('CIVILIZATION_DMS_BOTSWANA',	'EarthMk3',			33, 11),
		('CIVILIZATION_DMS_BOTSWANA',	'SouthernAfrica',	80, 34);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_DMS_BOTSWANA',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO JFD_Civilopedia_HideFromPedia
		(Type)
VALUES	('BUILDING_DMS_MOPHATO_CULTURE'),
		('BUILDING_DMS_THE_CLAY_THAT_BINDS_SPECIALIST'),
		('BUILDING_DMS_MOPHATO_PRODUCTION'),
		('BUILDING_DMS_KGOTLA_HAPPINESS');
--------------------------------------------------------------------------------------------------------------------------
-- LEADER FLAVOURS
--------------------------------------------------------------------------------------------------------------------------	
...
VALUES	('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_DECOLONIZATION',		 4),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_MERCENARY',				 7),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 1),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 5), --Scale of Liberal to Authoritarian.
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_LEGAL',			 6), 	
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_CULTURE',		 6),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_ECONOMIC',		 8),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 6),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_FOREIGN',		 7),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_INDUSTRY',		 7),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_MILITARY',		 7),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_REFORM_RELIGION',		 4),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_SLAVERY',				 2),
		('LEADER_DMS_SERETSE_KHAMA',	'FLAVOR_JFD_STATE_RELIGION',		 2);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_DMS_BOTSWANA',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, 'AS2D_SOUND_JFD_PORTUGUESE'

...
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'Yagem',				138,		66,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'Yahem',				20,		55,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'Cordiform',			12,		37,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'Greatest Earth',		8,		48,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'EarthMK3',				134,	70,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'Americas',				36,		55,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'AmericasGiant',		40,		118,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'NorthAmericaGiant',	59,		53,		null,	null,	null);

INSERT INTO Civilizations_YnAEMP
		(CivilizationType,						MapPrefix,				X,		Y,		AltX,	AltY,	AltCapitalName)
VALUES	('CIVILIZATION_ASQ_ARAPAHO',			'NorthAmericaHuge',		53,		41,		null,	null,	null);
...
SELECT	'CIVILIZATION_ASQ_ARAPAHO', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_DECOLONIZATION',		 3),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_MERCENARY',				 7),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 1),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_GOVERNMENT',		 2), --Scale of Liberal to Authoritarian.
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_LEGAL',			 5), 	
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_CULTURE',		 6),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_ECONOMIC',		 8),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_EDUCATION',	 	 4),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_FOREIGN',		 5),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_INDUSTRY',		 2),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_MILITARY',		 5),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_REFORM_RELIGION',		 2),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_SLAVERY',				 2),
		('LEADER_ASQ_PRETTYNOSE',			'FLAVOR_JFD_STATE_RELIGION',		 4);
...
SELECT	'CIVILIZATION_ASQ_ARAPAHO',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_SHOSHONE';

UPDATE Civilizations 
SET SoundtrackTag = 'JFD_Great_Plains'
WHERE Type = 'CIVILIZATION_ASQ_ARAPAHO'
AND EXISTS (SELECT * FROM Civilization_JFD_CultureTypes WHERE SoundtrackTag = 'JFD_Great_Plains');
--------------------------------------------------------------------------------------------------------------------------

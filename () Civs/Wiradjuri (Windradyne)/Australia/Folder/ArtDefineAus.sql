...
SELECT	'ART_DEF_UNIT_AS_AUS_LS_HANGMAN_CREDITS',		DamageStates,		Formation
FROM ArtDefine_UnitInfos				WHERE Type = 'ART_DEF_UNIT_U_MAYAN_ATLALIST';

INSERT INTO ArtDefine_UnitInfoMemberInfos (UnitInfoType,	UnitMemberInfoType,							NumMembers)
SELECT	('ART_DEF_UNIT_AS_AUS_LS_HANGMAN_CREDITS'),					('ART_DEF_UNIT_MEMBER_AS_AUS_LS_HANGMAN_CREDITS'),	NumMembers
...
SELECT	('ART_DEF_UNIT_MEMBER_AS_AUS_LS_HANGMAN_CREDITS'),			EnableActions,	DisableActions,	MoveRadius,	ShortMoveRadius,	ChargeRadius,	AttackRadius,	RangedAttackRadius,	MoveRate,	ShortMoveRate,	TurnRateMin,	TurnRateMax,	TurnFacingRateMin,	TurnFacingRateMax,	RollRateMin,	RollRateMax,	PitchRateMin,	PitchRateMax,	LOSRadiusScale,	TargetRadius,	TargetHeight,	HasShortRangedAttack,	HasLongRangedAttack,	HasLeftRightAttack,	HasStationaryMelee,	HasStationaryRangedAttack,	HasRefaceAfterCombat,	ReformBeforeCombat,	HasIndependentWeaponFacing,	HasOpponentTracking,	HasCollisionAttack,	AttackAltitude,	AltitudeDecelerationDistance,	OnlyTurnInMovementActions,	RushAttackFormation
...
SELECT	('ART_DEF_UNIT_MEMBER_AS_AUS_LS_HANGMAN_CREDITS'),	Scale,		ZOffset,		Domain,		('Inca_Atlatlist.fxsxml'),	MaterialTypeTag,	 MaterialTypeSoundOverrideTag

...
SELECT	'CIVILIZATION_SPLATDAY_DUTCH',	MapPrefix,			X,	Y
FROM Civilizations_YnAEMP WHERE CivilizationType = 'CIVILIZATION_NETHERLANDS';


INSERT INTO Civilizations_YnAEMP
		(CivilizationType, AltX,	AltY,	AltCapitalName)
SELECT	'CIVILIZATION_SPLATDAY_DUTCH',	AltX,	AltY,	'TXT_KEY_CITY_NAME_SPLATDAY_WILLIAM_02'
...
SELECT	'CIVILIZATION_SPLATDAY_DUTCH', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
FROM Civilizations_YnAEMPRequestedResources WHERE CivilizationType = 'CIVILIZATION_NETHERLANDS';
--------------------------------------------------------------------------------------------------------------------------
...
WHERE Type = 'CIVILIZATION_SPLATDAY_DUTCH';	
...
SELECT	('CIVILIZATION_SPLATDAY_DUTCH', ColonyName
FROM Civilization_JFD_ColonialCityNames WHERE CivilizationType = 'CIVILIZATION_NETHERLANDS';
--------------------------------------------------------------------------------------------------------------------------
-- LEADER FLAVOURS
--------------------------------------------------------------------------------------------------------------------------	
...
VALUES	('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_DECOLONIZATION',		 5),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_MERCENARY',				 9),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 7),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 9), 
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_LEGAL',			 8), 	
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_CULTURE',		 10),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_ECONOMIC',		 10),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 6),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_FOREIGN',		 6),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_INDUSTRY',		 5),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_MILITARY',		 4),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_REFORM_RELIGION',		 5),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_SLAVERY',				 9),
		('LEADER_SPLATDAY_WILLIAM',	'FLAVOR_JFD_STATE_RELIGION',		 9);
...
SELECT	'CIVILIZATION_SPLATDAY_DUTCH',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
